    ...
    export default {
        ...
        methods: {
            ...
            getDateItemsForFormEasy() {
                ...
                for (let i = 0, days = 0, mondayDate, currentDate = new Date(); i < this.attributes.quantityRepeatSelected; i++) {
                    currentDate.setDate(currentDate.getDate() + days);

                    mondayDate = this.getMondayDate(currentDate);

                    this.attributes.weekDaysSelected.forEach(day => {
                        dateItems.push(this.getFragmentsDateTime(this.getWeekDate(day, mondayDate)));
                    });
                    days += 7;
                }
            ...
            getDateItemsForFormExtended() {
                ...
                let totalDay = ((new Date(this.attributes.dateEnd)) - (new Date(this.attributes.dateStart))) / (1000 * 3600 * 24) + 1,
