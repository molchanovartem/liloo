        ...
        <div class="header__container">
            ...
            <div class="header__wrap content-width">
                ...
                <div class="header__wrap-part header__wrap-part_actions">
                    ...
                    <a href="" class="personal-avatar" style="background-image: url(https://leonardo.osnova.io/c5591b46-aefc-5aa2-7be1-9ba41cef3ea0/);">
                        <span class="personal-avatar__notifications">2</span>
                    </a>

                    <a href="" class="font_Gilroy-17-800-000000">Выйти</a>
            ...
            <div class="content-width mb-40">
                <div class="row-categories">
                    ...
                    <div class="row-categories__item"><a href="" class="row-categories__link row-categories__link_current">Виктор Субботин</a></div>
                </div>
            </div>
