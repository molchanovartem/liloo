    ...
    <div class="header__container">
        ...
        <div class="header__wrap content-width">
            ...
            <div class="header__wrap-part">
                ...
                <a class="logo" href="/"><img src="http://upload.wikimedia.org/wikipedia/commons/a/ab/Logo_TV_2015.png"
                            ...
                            <div class="footer-menu">
                                ...
                                <div class="footer-menu__uls">
                                    ...
                                    <ul class="footer-menu__ul">
                                        ...
                                        <li class="footer-menu__li"><a href="" class="footer-menu__a">Визажист</a></li>
                                        <li class="footer-menu__li"><a href="" class="footer-menu__a">Стилист</a></li>
                                        <li class="footer-menu__li"><a href="" class="footer-menu__a">Брови, ресницы</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="advice">
                            <div class="advice__block">
                                ...
                                <div class="advice__text">
                                    Адрес: <?php echo Html::encode($data['model']->address); ?>
                                </div>
                            </div>
                        </div>
                        <div class="advice">
