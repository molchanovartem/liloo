    ...
    <div class="header__container">
        ...
        <div class="content-width mb-40">
            ...
            <div class="row-categories">
                ...
                <div class="row-categories__item"><a href="" class="row-categories__link row-categories__link_current">Мастера</a></div>
            </div>

            <div class="inputs_in_row mt-40">
                <div class="input-box inputs_in_row__big">
                ...
                <div class="inputs_in_row__smalls">
                    <div class="input-boxes">
                        <div class="input-box">
                            <div class="input-box__wrap">
                                <input type="email" id="input_5" class="input-box__input">
                                <label for="input_5" class="input-box__label">Ваш город</label>
                            </div>
                        ...
                        <div class="input-box">
                            <div class="input-box__wrap">
                                <input type="email" id="input_6" class="input-box__input">
                                <label for="input_6" class="input-box__label">Желаемая дата записи</label>
                            </div>
                            <div class="input-box__additional">
                        ...
                        <div class="input-box">
                            <div class="input-box__wrap">
                                <input type="email" id="input_7" class="input-box__input">
                                <label for="input_7" class="input-box__label">Время записи</label>
                            </div>
                            <div class="input-box__additional">
                            ...
                            <div class="performers-select__item">
                                ...
                                <div class="performers-select__schedule">
                                    ...
                                    <div class="button button_color_red button_width_270 mt-10">
                                        <a href="../appointment/create" class="uk-button uk-button-text"
                                           data-window="true"
