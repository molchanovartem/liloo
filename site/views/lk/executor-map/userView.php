                        ...
                        <div class="uk-panel uk-margin-small-left">
                            <div class="review-slide__content">
                                ...
                                <?php if (strlen($recall->text) > 40) : ?>
                                    <div id="id-<?php echo $recall->id; ?>" class="toggle-animation-queued  review-slide__text uk-text-truncate">
                                        <?php echo Html::encode($recall->text); ?>
                                    </div>
                                    <div id="id-<?php echo $recall->id; ?>" class="toggle-animation-queued review-slide__text" hidden>
                                        <?php echo Html::encode($recall->text); ?>
                                    </div>

                                    <button class="uk-button uk-button-text uk-margin-small-top" type="button"
                                            uk-toggle="target: #id-<?php echo $recall->id; ?>; animation: uk-animation-fade; queued: true; duration: 0">
                                        Читать полностью
                                    </button>
                                <?php else : ?>
